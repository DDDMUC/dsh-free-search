...
const FREE_ENGINES = ["ddg", "ddg-lite", "bing"];
const ALL_ENGINES = ["ddg", "ddg-lite", "bing", "exa", "perplexity", "deepseek-official"];
    ...
    sctx.effect(() => {
      const section = {
        ...
        text: [
          ...
          "Current engine: " + (current().provider ?? "ddg"),
          "",
          "Available engines and their requirements:",
          "- ddg (DuckDuckGo HTML) - FREE, no key",
          "- ddg-lite (DuckDuckGo Lite) - FREE, no key",
          "- bing (Bing) - FREE, no key",
