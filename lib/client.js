      ...
      const load = react.useCallback(async () => {
        try {
          ...
          if (result.ok) {
            ...
            if (view) {
              setProvider(view.value.provider ?? "ddg");
            ...
            ? react_jsx_runtime.jsx("div", {
              ...
              react_jsx_runtime.jsx("span", { className: badgeClass, children: currentEngine.badge }),
                      ...
                      react_jsx_runtime.jsx("p", {
                        ...
                        children:
                          "FREE engines need no key and auto-fallback on failure. API KEY engines (exa / perplexity / deepseek) require credentials and fail with a clear error when the key is missing.",
                      }),
                    ],
                  }),
                  !ready
